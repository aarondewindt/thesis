...
The baseline leaves the expected value of the update unchanged, however it can have a large effect on it is variance and thus the learning rate. An appropriate choice for the baseline in an estimate of the state-value function $\hat{v}\left(S_t\right)$\cite{sutton2018reinforcement}. 
