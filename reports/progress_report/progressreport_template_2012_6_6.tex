...
\documentclass[a4paper,11pt]{article}
	...
	\begin{itemize}
		\item Finished simulation rewrite.
	\end{itemize}
	...
	\begin{enumerate}
		\item Add more advanced RL methods, TRPO, PPO, SAC, etc.
		\item Add some background theory needed for those.
		\item Finish approximate solutions section.
		\item High-throughput architectures (IMPALA).
		\item Code agent using RLlib.
	\end{enumerate}
