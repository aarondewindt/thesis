...
\documentclass[a4paper,11pt]{article}
	...
	\newcommand{\Term}{09/2018 - 12/2020}
	...
	\begin{itemize}
		\item Wrote launcher simulation environment.
		\item Trained agents on timing engine ignitions.
	\end{itemize}
	...
	\begin{itemize}
		\item Rewrote launcher simulation in order to give it the same interface as OpenAI environments. The new simulation is written in a numba class, significantly increasing performance. 10-100x faster.
		\item Implemented continues advantage actor-critic (A2C) with mixed success.
		\item I ended up going back to the pendulum in order to develop the A2C agent.
		\item Reorganized report and literature library.
		\item Wrote new introduction
		\item Investigated the use of an existing Reinforcement Learning framework so I don't have to start writing the agents from scratch.
		\item Collected and read literature on:
			\begin{itemize}
				\item Orbital ascent trajectory optimization.
				\item Reinforcement Learning in spacecraft navigation.
				\item Inverse Reinforcement Learning and similar methods of supervised or imitation RL.
			\end{itemize}
	\end{itemize}
	...
	\begin{enumerate}
		\item Summarize collected literature and make a draft plan for the thesis project.
	\end{enumerate}
