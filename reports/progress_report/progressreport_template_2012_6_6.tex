...
\documentclass[a4paper,11pt]{article}
	...
	\begin{itemize}
		\item Made planning for the coming two months
	\end{itemize}
	
	\section*{Plans for next 2 weeks}
	% Same as last week, since I haven't been able to progress.
	\begin{enumerate}
		\item Work and continuo with preliminary thesis in September after I've left my current job.
	\end{enumerate}
