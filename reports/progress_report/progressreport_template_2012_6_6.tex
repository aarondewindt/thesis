...
\documentclass[a4paper,11pt]{article}
	...
	\begin{itemize}
		\item Done with tabular methods chapter.
	\end{itemize}
	...
	\begin{itemize}
		\item Combined chapters 2 and 3 into one.
		\item Wrote introduction of (the new) chapter 3 (approximate solutions)
	\end{itemize}
	
	\section*{Plans for next 2 weeks}
	% Same as last week, since I haven't been able to progress.
	\begin{enumerate}
		\item Rewrite old inverted pole examples.
		\item Continue writing chapter 3.
	\end{enumerate}
